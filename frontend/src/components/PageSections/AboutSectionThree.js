            ...
            <div className="section-title">
              <h2>
                ...
                <span className="d-none d-md-block">
                  <i className="las la-arrow-down ml-40"></i>
                </span>
              </h2>
            </div>
            <div className="about-desc mt-60 pl-150">
              <p>
                MOD Arq is a team of experienced architects and interior
                designers who are passionate about creating beautiful,
                functional spaces. We believe that good design should be
                accessible to everyone, and we work hard to make sure that our
